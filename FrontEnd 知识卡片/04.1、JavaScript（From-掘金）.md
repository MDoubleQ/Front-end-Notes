![JavaScript面试题.png](E:\coder\09_OneNote\image\fc9240467b46494ca8fdc2d35d9f729etplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
下面看一下**双精度数是如何保存**的： ![img](E:\coder\09_OneNote\image\0cb225cf71d748a8b2d6a5615e402711tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值： ![img](E:\coder\09_OneNote\image\e55fc36b191340e69698782fbd67ef4ftplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp) 数组里的0、1、2索引位的元素值，精准地被映射到了左侧的第0、1、2个变量里去，这就是数组解构的工作模式。还可以通过给左侧变量数组设置空占位的方式，实现对数组中某几个元素的精准提取：
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量： ![img](E:\coder\09_OneNote\image\a14ffbb3df2646a4a84f4a0c7d62d975tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
这样就得到了 name 和 age 两个和 stu 平级的变量： ![img](E:\coder\09_OneNote\image\1ed2565845f2415b8243c8c355b2c6d6tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
**特点：** JavaScript 对象是通过引用来传递的，创建的每个新对象实体中并没有一份属于自己的原型副本。当修改原型时，与之相关的对象也会继承这一改变。 ![img](E:\coder\09_OneNote\image\c68fcad75ea54d62a9404aa02cafc65ctplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
由于`Object`是构造函数，原型链终点是`Object.prototype.__proto__`，而`Object.prototype.__proto__=== null // true`，所以，原型链的终点是`null`。原型链上的所有原型都是对象，所有的对象最终都是由`Object`构造的，而`Object.prototype`的下一级是`Object.prototype.__proto__`。 ![img](E:\coder\09_OneNote\image\30821909377545248d244b0a4e965bb1tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
...
![img](E:\coder\09_OneNote\image\40194bdc07024b78b6da8bb43d84a7d8tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp) func1的运行结果其实就是一个Promise对象。因此也可以使用then来处理后续逻辑。
...
![img](E:\coder\09_OneNote\image\507e439801c043739c4667567e5f8562tplv-k3u1fbpfcp-zoom-in-crop-mark1512000.webp)
